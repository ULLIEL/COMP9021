...
##    '''
    ...
    if n > 2:
        result1 = bin(2)
        print(f'{n} in binary reads as: {result1}.')
        result2 = result1.count('1')
        print(f'{result2} bits are set to 1 in the binary representation of {n}.')
    else:
        result1 = bin(2)
        print(f'{n} in binary reads as: {result1}.')
        result2 = result1.count('1')
        print(f'Only one bit set to 1 in the binary representation of {n}.')
